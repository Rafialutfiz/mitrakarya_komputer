...
<div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
    <div class="flex h-full items-center">
      <main class="w-full max-w-md mx-auto p-6">
        <div class="mt-7 bg-zinc-800 border-gray-200 rounded-xl shadow-sm dark:bg-gray-800 dark:border-gray-700">
          <div class="p-4 sm:p-7">
            <div class="text-center">
              <h1 class="block text-2xl font-bold text-white dark:text-white">Reset password</h1>
            </div>
            ...
            <div class="mt-5">
              ...
              <form>
                <div class="grid gap-y-4">
                  ...
                  <div>
                    <label for="password_confirmation" class="block text-sm mb-2 text-white">Confirm Password</label>
                    <div class="relative">

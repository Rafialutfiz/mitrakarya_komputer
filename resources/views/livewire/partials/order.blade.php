...
<div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
    ...
    <div class="flex flex-col bg-zinc-800 p-5 rounded mt-4 shadow-lg">
        ...
        <div class="p-1.5 min-w-full inline-block align-middle">
          <div class="overflow-hidden">
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
              ...
              <tbody>
                <tr class="bg-zinc-500 even:bg-gray-100 dark:odd:bg-slate-900 dark:even:bg-slate-800">
                  ...
                  <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium">
                    <a href="#" class="bg-slate-600 text-white py-2 px-4 rounded-md hover:bg-slate-500">Detail</a>
                  </td>
                </tr>
